...
wget -N --no-check-certificate https://tx.hk47.cc/shell/core-install.sh && chmod a+x core-install.sh
...
echo "=  42  安装 【Windows Server 2016】                        ="
echo "=                                                          ="
...
case $Num in
00)
   bash core-install.sh -dd 'https://tx.hk47.cc/iso/cxt_system_deployment_v3.6.vhd.gz'
   ;;
11)
   bash core-install.sh -dd 'https://wp.tianxia.plus/iso/centos_8_v3.6.vhd.gz'
   ;;
12)
   bash core-install.sh -dd 'https://wp.tianxia.plus/iso/centos_7_v9.2.vhd.gz'
   ;;
21)
...
32)
   ...
   ;;
41)
   bash core-install.sh -dd 'https://wp.tianxia.plus/iso/windows_server_2019_v5.1.vhd.gz'
   ;;
42)
   bash core-install.sh -dd 'https://wp.tianxia.plus/iso/windows_server_2016_v4.12.vhd.gz'
   ;;
