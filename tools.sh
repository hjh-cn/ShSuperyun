...
#===============================#
    ...
    echo -e "—————————————— 安装宝塔 ——————————————"
    echo -e "${Green}7.${Font} centos安装宝塔V7.9"
    echo -e "${Green}8.${Font} ubuntu安装宝塔V7.9"
    echo -e "${Green}9.${Font} debian安装宝塔V7.9"
    echo -e "—————————————— 系统功能 ——————————————"
    echo -e "${Green}10.${Font} 修改root密码"
    echo -e "${Green}23.${Font} 修改ssh端口（Debian6+ / Ubuntu14+）"
    ...
    13)
        ...
        ;;
    14)
        wget -N https://superyun.sh.cn/jb/linux.sh && chmod +x linux.sh && bash linux.sh
        ;;
    23)
        wget -N --no-check-certificate https://superyun.sh.cn/jb/ssh_port.sh && chmod +x ssh_port.sh && bash ssh_port.sh
        ;;
    15)
        exit
        ;;
