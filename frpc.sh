...
download_file(){
    ...
    mkdir -p /root/frpc
    cd /root/frpc
    wget --no-check-certificate https://tx.hk47.cc/deb-rpm/frp/frp_${version}_linux_amd64.tar.gz
...
start_frpc(){
    ...
    8)
        ...
        ;;
    9)
        curl -O -L https://superyun.sh.cn/jb/frps.sh && chmod +x frps.sh && bash frps.sh
        ;;
    10)
